      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            {/* Tools & Technologies */}
            <div className="glass-card p-8 rounded-[2rem] border border-zinc-800 mb-8 sticky top-8">
            ...
            <Link
              to="/#contact"
              className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-6 rounded-[2rem] font-bold text-center hover:scale-105 transition-transform shadow-lg shadow-indigo-500/20"
            >
              {capacity.cta}
            </Link>
          </div>
